      ...
      <div className="absolute bottom-0 left-0 right-0 p-5 sm:p-7">
        <div className="flex items-end justify-between gap-5">
          <div>
            ...
            <p
              className={`mt-2 font-editorial leading-none text-white ${
          ...
          <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-white/20 bg-white/10 text-white backdrop-blur-md transition-transform duration-500 group-hover:rotate-45">
...
function StorySmallImage({ item, index }) {
  return (
    ...
    >
      ...
      <span className="absolute bottom-4 left-4 right-4 font-editorial text-lg leading-none text-white">
        {getCaption(item)}
      </span>
    </motion.div>
  );
